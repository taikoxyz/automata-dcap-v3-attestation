...
contract V3JsonUtils {
    ...
    {
        success = true;
        ParsedV3QuoteStructHelper memory v3quoteHelper = abi.decode(
            v3QuotePacked,
            (ParsedV3QuoteStructHelper)
        );

        // setup header
        v3quote.header.version = bytes2(v3quoteHelper.header.version);
        v3quote.header.attestationKeyType = bytes2(
            v3quoteHelper.header.attestationKeyType
        );
        ...
        v3quote.localEnclaveReport.cpuSvn = bytes16(
            v3quoteHelper.localEnclaveReport.cpuSvn
        );
        v3quote.localEnclaveReport.miscSelect = bytes4(
            v3quoteHelper.localEnclaveReport.miscSelect
        );
        v3quote.localEnclaveReport.reserved1 = bytes28(
            v3quoteHelper.localEnclaveReport.reserved1
        );
        v3quote.localEnclaveReport.attributes = bytes16(
            v3quoteHelper.localEnclaveReport.attributes
        );
        v3quote.localEnclaveReport.mrEnclave = v3quoteHelper
            .localEnclaveReport
            .mrEnclave;
        v3quote.localEnclaveReport.reserved2 = v3quoteHelper
            .localEnclaveReport
            .reserved2;
        v3quote.localEnclaveReport.mrSigner = v3quoteHelper
            .localEnclaveReport
            .mrSigner;
        v3quote.localEnclaveReport.reserved3 = bytes(
            v3quoteHelper.localEnclaveReport.reserved3
        );
        v3quote.localEnclaveReport.isvProdId = uint16(
            v3quoteHelper.localEnclaveReport.isvProdId
        );
        v3quote.localEnclaveReport.isvSvn = uint16(
            v3quoteHelper.localEnclaveReport.isvSvn
        );
        v3quote.localEnclaveReport.reserved4 = bytes(
            v3quoteHelper.localEnclaveReport.reserved4
        );
        v3quote.localEnclaveReport.reportData = bytes(
            v3quoteHelper.localEnclaveReport.reportData
        );

        // setup v3AuthData
        v3quote.v3AuthData.ecdsa256BitSignature = bytes(
            v3quoteHelper.v3AuthData.ecdsa256BitSignature
        );
        v3quote.v3AuthData.ecdsaAttestationKey = bytes(
            v3quoteHelper.v3AuthData.ecdsaAttestationKey
        );
        v3quote.v3AuthData.pckSignedQeReport = V3Struct.EnclaveReport({
            ...
            miscSelect: bytes4(
                v3quoteHelper.v3AuthData.pckSignedQeReport.miscSelect
            ),
            reserved1: bytes28(
                v3quoteHelper.v3AuthData.pckSignedQeReport.reserved1
            ),
            attributes: bytes16(
                v3quoteHelper.v3AuthData.pckSignedQeReport.attributes
            ),
            ...
            reserved3: bytes(
                v3quoteHelper.v3AuthData.pckSignedQeReport.reserved3
            ),
            isvProdId: uint16(
                v3quoteHelper.v3AuthData.pckSignedQeReport.isvProdId
            ),
            isvSvn: uint16(v3quoteHelper.v3AuthData.pckSignedQeReport.isvSvn),
            reserved4: bytes(
                v3quoteHelper.v3AuthData.pckSignedQeReport.reserved4
            ),
            reportData: bytes(
                v3quoteHelper.v3AuthData.pckSignedQeReport.reportData
            )
        });
        v3quote.v3AuthData.qeReportSignature = bytes(
            v3quoteHelper.v3AuthData.qeReportSignature
        );
        v3quote.v3AuthData.qeAuthData = V3Struct.ParsedQEAuthData({
            parsedDataSize: uint16(
                v3quoteHelper.v3AuthData.qeAuthData.parsedDataSize
            ),
        ...
        v3quote.v3AuthData.certification = V3Struct.ParsedCertificationData({
            ...
            certDataSize: uint32(
                v3quoteHelper.v3AuthData.certification.certDataSize
            ),
